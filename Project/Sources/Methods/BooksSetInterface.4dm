...
If (<>booksEditMode=True:C214)
	...
	OBJECT SET BORDER STYLE:C1262(*;"@Field@";Bordure Système:K42:33)
	  // turn listbox to grey (to simulate inactivity (but still is available)
	OBJECT SET RGB COLORS:C628(*;"listBoxBooks";0x00C0C0C0;Coul arrière plan:K23:2)  // foreground /  background
...
Else 
	...
	OBJECT SET BORDER STYLE:C1262(*;"@Field@";Bordure Aucune:K42:27)
	
	OBJECT SET RGB COLORS:C628(*;"listBoxBooks";Coul arrière plan:K23:2;Coul premier plan:K23:1)
