...
If ($n=1)
	...
	Else 
		...
		<>bookStatus:="Borrowed on "+String:C10([Loans:2]borrowDate:3)+Char:C90(Retour chariot:K15:38)  // <TRANSLATION>
		<>bookStatus:=<>bookStatus+"by "+[Students:3]firstName:3+" "+[Students:3]lastName:2+"."+Char:C90(Retour chariot:K15:38)  // <TRANSLATION>
		<>bookStatus:=<>bookStatus+"Return expected on "+String:C10([Loans:2]returnDate:4;Système date court:K1:1)+"."  // <TRANSLATION>
