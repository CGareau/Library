...
$text:=SVG_New_textArea ($bookRef;$title;$margin;2*$margin;400-(2*$margin);400;$font;30+(Random:C100%10);Normal:K14:1;3)

$margin:=60
$text:=SVG_New_textArea ($bookRef;$author;$margin;400;400-(2*$margin);400;$font;20+(Random:C100%10);Normal:K14:1;3)
